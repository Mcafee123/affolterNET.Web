...
namespace affolterNET.Auth.Api.Services;

public class ApiClaimsEnrichmentService : IClaimsEnrichmentService
{
    private readonly IPermissionService _permissionService;
    private readonly ILogger<ApiClaimsEnrichmentService> _logger;
    private readonly ApiAuthOptions _options;

    public ApiClaimsEnrichmentService(
